...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/comment/regeist?status=2">科目列表</a></li>
		<li class="active"><a href="${ctx}/cms/comment/formRegeist2?id=${notice.id}">科目<shiro:hasPermission name="oa:oaNotify:edit">${not empty course.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="notice" action="${ctx}/cms/comment/saveRegeist2" method="post" class="form-horizontal">
