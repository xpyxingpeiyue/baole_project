...
<body>
	...
	<!-- 华师班注册 -->
		<li><a href="${ctx}/cms/comment/exam?status=2">须知列表</a></li>
		<li class="active"><a href="${ctx}/cms/comment/formExam2?id=${notice.id}">注册须知<shiro:hasPermission name="oa:oaNotify:edit">${not empty notice.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="notice" action="${ctx}/cms/comment/saveExam2" method="post" class="form-horizontal">
