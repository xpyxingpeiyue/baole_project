        ...
        <div class="entrance-form">
            <form>
                <div class="form-group">
                    选择项：
                    <input type="radio" name="Radios" value="Radios1" checked>华师班报名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="Radios" value="Radios2">特长班报名
                </div>
                <div class="form-group entrance-btn-wrap">
                    <input type="submit" value="登录" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="reset" value="注册" class="btn btn-warning">
                </div>
            </form>
        </div>
    </div>
